...
import { Home as HomeIcon, ShoppingBag, ShieldCheck, Users, Search } from 'lucide-react';
...
export default function BottomNav() {
  ...
  const navItems = [
    { href: '/', label: 'Home', icon: HomeIcon, count: 0 },
    { href: '#', label: 'Search', icon: Search, count: 0 },
    { href: '/cart', label: 'Cart', icon: ShoppingBag, count: cartCount },
    { href: '/membership', label: 'Membership', icon: ShieldCheck, count: 0 },
    { href: '/join-our-team', label: 'Team', icon: Users, count: 0 },
  ];
